...
file.choose()
setwd("/Users/KatherineHannibal/IPM-Mytilus-edulis/Data/Mytilus_IPM_kernel functions.R")
...
{
  mu <- m.par["grow.int"] + m.par["grow.z"] * z           # mean size next year #80(80-0.219)*e(-0.0163t)) 
